...
export const SERVICES: Record<ServiceSlug, ServiceContent> = {
  personas: {
    ...
    heroImage: "/images/landing/screenshots/public-profile.png",
    heroImageAlt:
      "Perfil público de emergencia con contactos e instrucciones visibles al escanear",
  ...
  mascotas: {
    ...
    heroImage: "/images/products/collar-qr.png",
    heroImageAlt: "Collar para mascota con chapita y código QR SOSme",
  ...
  objetos: {
    ...
    heroImage: "/images/products/sticker-qr.jpg",
    heroImageAlt: "Sticker con código QR pegado en una valija de viaje",
